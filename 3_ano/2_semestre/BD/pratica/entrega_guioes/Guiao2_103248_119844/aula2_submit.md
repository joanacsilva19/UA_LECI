...
As entidades são: 
    - os produtos, que têm como atributos um código, nome, preço e taxa de IVA; 
    - as encomendas, que têm como atributos o número de encomenda, a data em que foi realizada e um fornecedor único;
    - os fornecedores, que têm como atributos um nome, número de informação fiscal, endereço, número de fax, condições de pagamento e um código interno do tipo de fornecedor;
    - o tipo de fornecedor, que tem como atributos uma designação;
    - a condição de pagamento, que tem como atributos o tipo de pagamento (pronto, 30 dias, 60 dias, etc).

As relações entre as diferentes entidades são:
    1 - As encomendas podem ter um ou mais produtos.
    2 - Cada encomenda tem um único fornecedor.
    3 - Cada fornecedor pode ter uma ou mais encomendas.
    4 - Cada fornecedor tem um tipo de fornecedor associado.
    5 - Cada fornecedor aceita vários métodos de pagamento.
...
```
Todas as relações são de grau binário.
Em relação à cardinalidade e obrigatoriedade de participação das instâncias das entidades no relacionamento (ver resposta anterior):
    1 - cardinalidade: M:N ; obrigatoriedade: as encomendas dependem dos produtos, logo a participação das instancias da entidade "encomendas" na relação é obrigatória/total e a de "produto" é opcional/parcial.
    2 - cardinalidade: 1:1 ; obrigatoriedade: o fornecedor depende das encomendas, logo a participação de "encomendas" é obrigatória/total e a de "fornecedores" é opcional/parcial.
    3 - cardinalidade: 1:N ; obrigatoriedade: o fornecedor depende das encomendas, logo a participação de "fornecedor" é obrigatória/total e a de "encomendas" é opcional/parcial.
    4 - cardinalidade: 1:1 ; obrigatoriedade: o tipo de fornecedor depende do fornecedor, logo a participação de "fornecedor" é obrigatória/total e a de "tipo de fornecedor" é opcional/parcial.
    5 - cardinalidade: 1:N ; obrigatoriedade: os métodos de pagamento dependem do fornecedor, logo a participação de "métodos de pagamento" é obrigatória/total e a de "fornecedor" é opcional/parcial.
